...
namespace Aspenlaub.Net.GitHub.CSharp.Backbend.Web.Attributes {
    public class DvinExceptionFilterAttribute : ExceptionFilterAttribute {
        ...
        public override void OnException(ExceptionContext context) {
            ExceptionSaver.SaveUnhandledException(ExceptionLogFolder, context.Exception, nameof(GitHub.CSharp.Dvin), e => { });
